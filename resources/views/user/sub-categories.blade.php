                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('user.categories') }}">{{ $category->name }}</a></li>
                                ...
                                <div class="card table-card">
                                    <div class="card-body">
                                        <div class="text-end p-4 pb-sm-2">
                                            <a href="{{ route('user.add-sub-category', ['id' => $id]) }}"
                                                class="btn btn-primary d-inline-flex align-items-center gap-2"><i
                                                    class="ti ti-plus f-18"></i> Add Category</a>
                                        </div>
                                       @livewire('user.sub-category', ['id' => $id])
                                    </div>
                                </div>
                            </div>
                        </div>
